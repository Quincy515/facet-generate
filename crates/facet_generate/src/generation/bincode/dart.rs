...
//! (serialize / deserialize methods) for Dart Bincode code generation.
//!
...
/// Renders a Dart type expression for `format` without requiring a
/// language tag — the mapping is fixed for Dart regardless of encoding.
...
mod tests {
    ...
    fn module_helpers_emit_list_of_t() {
        ...
        let plugin = &BincodePlugin as &dyn EmitterPlugin<Dart>;
